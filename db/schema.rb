...
ActiveRecord::Schema[7.0].define(version: 2024_04_26_003158) do
  ...
  create_table "lws_timelines", force: :cascade do |t|
    ...
    t.string "level"
    t.bigint "timeline_id"
    t.index ["timeline_id"], name: "index_lws_timelines_on_timeline_id"
  ...
  add_foreign_key "lws_timelines", "timelines"
