...
ActiveRecord::Schema[7.0].define(version: 2026_02_10_110407) do
  ...
  create_table "learner_finance_updates", force: :cascade do |t|
    t.bigint "learner_info_id", null: false
    t.bigint "learner_finance_id", null: false
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["approved_by_id"], name: "index_learner_finance_updates_on_approved_by_id"
    t.index ["learner_finance_id"], name: "index_learner_finance_updates_on_learner_finance_id"
    t.index ["learner_info_id", "effective_date"], name: "index_learner_finance_updates_on_learner_info_id_and_date", unique: true
    t.index ["learner_info_id"], name: "index_learner_finance_updates_on_learner_info_id"
  end
  ...
  create_table "learner_finances", force: :cascade do |t|
    ...
    t.decimal "admission_fee", precision: 10, scale: 2
    t.decimal "discount_af", precision: 6, scale: 2
    t.decimal "billable_af", precision: 10, scale: 2
  ...
  add_foreign_key "learner_finance_updates", "learner_finances"
  add_foreign_key "learner_finance_updates", "learner_infos"
  add_foreign_key "learner_finance_updates", "users", column: "approved_by_id"
